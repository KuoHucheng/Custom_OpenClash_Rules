...
```text
https://testingcf.jsdelivr.net/gh/KuoHucheng/Custom_OpenClash_Rules@main/cfg/Custom_Clash.ini
```

Custom_Clash_GFW.ini

```text
https://testingcf.jsdelivr.net/gh/KuoHucheng/Custom_OpenClash_Rules@main/cfg/Custom_Clash_GFW.ini
```

Custom_Clash_Lite.ini

```text
https://testingcf.jsdelivr.net/gh/KuoHucheng/Custom_OpenClash_Rules@main/cfg/Custom_Clash_Lite.ini
```

Custom_Full_Clash.ini

```text
https://testingcf.jsdelivr.net/gh/KuoHucheng/Custom_OpenClash_Rules@main/cfg/Custom_Clash_Full.ini
```
